let answers = {
  ...
  "h": {
    "description": "Вы – доктор Брюс Бэннер, а иначе Халк. Нереально умный и столь же раздражительный. Вас можно или обожать, или бояться. Если вас разозлить, превращаетесь натурально в танк, сметающий все на своем пути. Многие восхищаются вашей искренностью, вы не сплетничаете за спиной, а способны сказать все в глаза. У вас нет десятков друзей. Зато есть несколько самых лучших, которые принимают вас таким, какой вы есть, и это круто!",
    "image": "img/h.jpg"
  },
  "t": {
    "description": "Вы – Тор, бог грома и доблестный воин. С детства смелый и отважный. Сколько себя помните, вы слышите про то, какой у вас могучий интеллект, но в 12 вам было интереснее всячески развлекаться, а к 30 годам, в общем, ничего не изменилось. Для вас многое значит семья, вы способны встать горой за любимого человека. Вы честный, открытый и упрямый, а еще способны удивлять в самый неожиданный момент.",
    "image": "img/t.jpg"
  },
  "f": {
    "description": "Вы – Соколиный глаз. Вы человек загадочный, как правило, замкнуты и молчаливы. Но при этом вы очень-очень надежный соратник и верный друг. Те, кому удалось войти к вам в доверие, знают, что в действительности за вашей маской тишины скрываются хладнокровие, выдержка и тонкий расчет. Гвозди бы делать из таких людей!",
    "image": "img/f.webp"
  }
};
